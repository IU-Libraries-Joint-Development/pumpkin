class UniversalViewer
  ...
  def script_tag
    content_tag(:script, '', type: 'text/javascript', id: 'embedUV', src: viewer_link)
  end

  def viewer_link
    safe_join([Rails.application.config.relative_url_root, viewer_root, "uv-#{viewer_version}", 'lib', 'embed.js'], '/')
  end
